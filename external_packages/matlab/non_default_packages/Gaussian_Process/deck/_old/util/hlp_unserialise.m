        ...
        try
            ...
            for fn=fieldnames(conts)'
                try
                    ...
                    % a struct.
                    warn_once('hlp_unserialise:restricted_access','No permission to set property %s in object of type %s.',fn{1},cls);
                end
            end
        catch
            v = conts;
            v.hlp_unserialise_failed = ['could not construct class: ' cls];
        end
    end
end
end
