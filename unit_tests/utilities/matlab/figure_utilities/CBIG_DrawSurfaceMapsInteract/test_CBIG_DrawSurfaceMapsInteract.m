classdef test_CBIG_DrawSurfaceMapsInteract < matlab.unittest.TestCase
% Written by Nanbo Sun, Zhang Shaoshi and CBIG under MIT license: https://github.com/ThomasYeoLab/CBIG/blob/master/LICENSE.md
    ...
    methods (Test)
        function test_fsaverage_mesh(testCase)
            ...
            cur_dir = fullfile(CBIG_CODE_DIR, 'unit_tests', 'utilities', 'matlab', 'figure_utilities', 'CBIG_DrawSurfaceMapsInteract');
            ...
            CBIG_DrawSurfaceMapsInteract(lh_data, rh_data, mesh_name, surf_type, min_thresh, max_thresh);
            ...
            if(replace_unittest_flag)
                disp('Replacing unit test reference results fo DrawSurfaceMapsInteract, fsaverage_mesh...')
        ...
        function test_parcellation_input(testCase)
            ...
            CBIG_DrawSurfaceMapsInteract(lh_labels, rh_labels, mesh_name, surf_type, ...
