classdef test_CBIG_LRR_workflow_1measure < matlab.unittest.TestCase
    ...
    methods (Test)
        function test_basic( TestCase )
            ...
            if replace_unittest_flag
                ...
                ref_outdir = fullfile(parent_dir, 'ref_output', 'test_basic', 'results', 'optimal_acc');
                mkdir(ref_outdir)
                CBIG_LRR_workflow_1measure( params );
                
                filename = '1cog.mat';
                source = fullfile(params.outdir, 'results', 'optimal_acc', filename);
