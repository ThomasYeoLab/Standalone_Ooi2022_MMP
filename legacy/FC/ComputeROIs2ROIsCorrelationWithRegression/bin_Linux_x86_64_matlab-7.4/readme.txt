   ...
   environment variable. 
	...
	A. Locate the name of the environment variable to set, using the 
	 ...
	 NOTE: When deploying C and C++ standalone applications, it is possible
               to run the shell script file run_ComputeROIs2ROIsCorrelationWithRegression.sh on UNIX and Mac
...
3. Create packages that contain the following files, based on what
   you are deploying: 
	...
	All Platforms:
		* ComputeROIs2ROIsCorrelationWithRegression.ctf (Component Technology File archive,
		  platform-dependent on target machine)
			
	Windows:
		* MCRInstaller.exe (self-extracting MATLAB Component Runtime
		  library archive)  
		* ComputeROIs2ROIsCorrelationWithRegression.exe (application created by MATLAB Compiler)
	UNIX:
		* MCRInstaller.zip (MATLAB Component Runtime library 
	 	  archive - manual unzip required)
		* ComputeROIs2ROIsCorrelationWithRegression (application created by MATLAB Compiler)
		* run_ComputeROIs2ROIsCorrelationWithRegression.sh (shell script that can be run 
	...
	All Platforms:            
		* ComputeROIs2ROIsCorrelationWithRegression.so (shared library, file extension 
		  varies by platform)
		* ComputeROIs2ROIsCorrelationWithRegression.h (library header file)
		* ComputeROIs2ROIsCorrelationWithRegression.ctf (Component Technology File archive,
		  platform-dependent on target machine)
	...
	* ComputeROIs2ROIsCorrelationWithRegression.ctf (Component Technology File archive)	
	* ComputeROIs2ROIsCorrelationWithRegression.xml (documentation files)
	* ComputeROIs2ROIsCorrelationWithRegression.pdb (program database file - if 
	  DEBUG option selected)
	* ComputeROIs2ROIsCorrelationWithRegression.dll (component assembly file)
	* MCRInstaller.exe (self-extracting MATLAB Component Runtime
	  library archive)  
	...
	* ComputeROIs2ROIsCorrelationWithRegression.ctf (Component Technology File archive)
	* ComputeROIs2ROIsCorrelationWithRegression_1_0.dll (component containing 
	  compiled M-code)
	...
	* ComputeROIs2ROIsCorrelationWithRegression.jar (Java archive containing Java 
	  interface to M-code in ComputeROIs2ROIsCorrelationWithRegression.ctf)
	* ComputeROIs2ROIsCorrelationWithRegression.ctf (Component Technology File archive,
	  platform-dependent on target machine)
