   ...
   environment variable. 
	...
	A. Locate the name of the environment variable to set, using the 
	 ...
	 NOTE: When deploying C and C++ standalone applications, it is possible
               to run the shell script file run_ComputeROIs2WholeBrainCorrelationWithRegression.sh on UNIX and Mac
...
3. Create packages that contain the following files, based on what
   you are deploying: 
	...
	All Platforms:
		* ComputeROIs2WholeBrainCorrelationWithRegression.ctf (Component Technology File archive,
		  platform-dependent on target machine)
			
	Windows:
		* MCRInstaller.exe (self-extracting MATLAB Component Runtime
		  library archive)  
		* ComputeROIs2WholeBrainCorrelationWithRegression.exe (application created by MATLAB Compiler)
	UNIX:
		* MCRInstaller.zip (MATLAB Component Runtime library 
	 	  archive - manual unzip required)
		* ComputeROIs2WholeBrainCorrelationWithRegression (application created by MATLAB Compiler)
		* run_ComputeROIs2WholeBrainCorrelationWithRegression.sh (shell script that can be run 
	...
	All Platforms:            
		* ComputeROIs2WholeBrainCorrelationWithRegression.so (shared library, file extension 
		  varies by platform)
		* ComputeROIs2WholeBrainCorrelationWithRegression.h (library header file)
		* ComputeROIs2WholeBrainCorrelationWithRegression.ctf (Component Technology File archive,
		  platform-dependent on target machine)
	...
	* ComputeROIs2WholeBrainCorrelationWithRegression.ctf (Component Technology File archive)	
	* ComputeROIs2WholeBrainCorrelationWithRegression.xml (documentation files)
	* ComputeROIs2WholeBrainCorrelationWithRegression.pdb (program database file - if 
	  DEBUG option selected)
	* ComputeROIs2WholeBrainCorrelationWithRegression.dll (component assembly file)
	* MCRInstaller.exe (self-extracting MATLAB Component Runtime
	  library archive)  
	...
	* ComputeROIs2WholeBrainCorrelationWithRegression.ctf (Component Technology File archive)
	* ComputeROIs2WholeBrainCorrelationWithRegression_1_0.dll (component containing 
	  compiled M-code)
	...
	* ComputeROIs2WholeBrainCorrelationWithRegression.jar (Java archive containing Java 
	  interface to M-code in ComputeROIs2WholeBrainCorrelationWithRegression.ctf)
	* ComputeROIs2WholeBrainCorrelationWithRegression.ctf (Component Technology File archive,
	  platform-dependent on target machine)
