...
================================
-run_ComputeROIs2WholeBrainCorrelationWithRegression.sh (shell script run to temporarily 
 set environment variables and execute the application)
   -to run the shell script, type
   
       ./run_ComputeROIs2WholeBrainCorrelationWithRegression.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/R2010a/v714, run the shell script as:
       ...
       ./run_ComputeROIs2WholeBrainCorrelationWithRegression.sh /mathworks/home/application/R2010a/v714
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_ComputeROIs2WholeBrainCorrelationWithRegression.sh /mathworks/devel/application/matlab
-MCRInstaller.dmg 
   -include when building component by selecting "include MCR" option 
    in deploytool
-The Macintosh bundle directory structure ComputeROIs2WholeBrainCorrelationWithRegression.app 
   -this can be gathered up using the zip command 
    zip -r ComputeROIs2WholeBrainCorrelationWithRegression.zip ComputeROIs2WholeBrainCorrelationWithRegression.app
    or the tar command 
    tar -cvf ComputeROIs2WholeBrainCorrelationWithRegression.tar ComputeROIs2WholeBrainCorrelationWithRegression.app
-This readme file 
    ...
    Mac                     DYLD_LIBRARY_PATH
     ...
     ii. Set the path by doing one of the following:
        ...
        NOTE: When deploying standalone applications, it is possible 
              to run the shell script file run_ComputeROIs2WholeBrainCorrelationWithRegression.sh 
