...
% to this function. In the mean while, if you would like to project from fslr to fsaverage, please refer
% to CBIG_project_fsLR2fsaverage.m or CBIG_project_fsLR2fsaverage.sh in our repository.
%
% Input:
