...
%
% Note that this function is already depreciated. It is kept only because it is written by Alex and used
% in his project. In case we need to replicate some of his results in the future, we may want to refer
% to this function. In the mean while, if you would like to project from fsaverage to fslr, please refer
% to CBIG_project_fsaverage2fsLR.m or CBIG_project_fsaverage2fsLR.sh in our repository.
% Input:
%      - lh_label, rh_label:
