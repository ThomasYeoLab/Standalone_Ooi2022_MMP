/*$Header: /data/petsun4/data1/src_solaris/actmapf_4dfp/RCS/actmapf_4dfp.c,v 1.30 2006/09/24 00:25:39 avi Exp $*/
...
/* global variables */
/********************/
static char rcsid[] = "$Id: actmapf_nifti.c,v 1.30 2006/09/24 00:25:39 avi Exp $";
...
*/
	...
	free (vol); free (outbuffer); free (sbuffer); 
	exit (status);
}
/*********************************************************************************/
