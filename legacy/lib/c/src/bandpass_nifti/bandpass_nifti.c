/* $Header: /autofs/space/nexus_001/users/nexus-tools/cvsrepository/nifti_tools/bandpass_nifti/bandpass_nifti.c,v 1.1 2008/08/10 20:17:05 mtt24 Exp $*/
/* $Log: bandpass_nifti.c,v $
/* Revision 1.1  2008/08/10 20:17:05  mtt24
/* revision one
/*
...
static char rcsid[] = "$Id: bandpass_nifti.c,v 1.1 2008/08/10 20:17:05 mtt24 Exp $";
...
/*************************************/
	...
	free (tpad), free (x); free (imgt), free (oldtpad), free (vol), free(buffer[file]);
