#! /bin/csh -f
# This script will re-run the standard preprocessing pipeline from fcMRI preprocessing (i.e. spatial blurring -> bandpass filtering -> regression of movement regressors (+derivatives) and 5 CompCor components), and then volume projection
...
## ---------------------------
cd $sdir
set cmd = "${root_dir}/CompCorSurface/fcMRI_preproc_nifti_NoGlobReg_CompCor.csh $subject >& $sdir/$subject/logs/fcMRI_preprocess.log"
