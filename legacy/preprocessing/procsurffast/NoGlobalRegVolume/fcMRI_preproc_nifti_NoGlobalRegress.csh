...
# No whole-brain signal regression will be performed, i.e. regressors include		#
# motion parameters, ventricle, white matter (+derivatives)				#
...
###############################
PASTE:
paste $subject"_mov_regressor".dat $subject"_vent_wm_dt".dat >! $subject"_regressors".dat	
