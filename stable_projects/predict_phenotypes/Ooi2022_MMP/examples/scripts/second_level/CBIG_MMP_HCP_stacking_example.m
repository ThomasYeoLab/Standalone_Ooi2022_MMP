function CBIG_MMP_HCP_stacking_example(outerFolds, innerFolds, krr_output_dir, feature_mats_cell, ...
...
for fold_idx = 1:num_outer_folds
    ...
    subfold = load(fullfile(krr_output_dir,feature_outstem, seed_name,'results','no_relative_3_fold_sub_list.mat'));
