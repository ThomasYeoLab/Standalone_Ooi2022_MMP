...
# 
# EXAMPLE: 
#	CBIG_MMP_HCP_KRR_example.sh $feature_path $outdir $outerFolds $innerFolds $subtxt $scorecsv \
#		$restrictedcsv $predvar $covtxt $ymat $covmat $split_idx
# EXAMPLE OF HOW TO CALL FUNCTION:
# 	CBIG_MMP_HCP_KRR_example.sh data_dir/features/rs.mat output_dir 10 10 data_dir/subs.txt \
...
LF="$outdir/$outstem/logs/${outstem}_${split_idx}.log"
...
matlab -nodesktop -nosplash -nodisplay -r " try addpath('$script_dir'); CBIG_MMP_HCP_KRR_example( \
