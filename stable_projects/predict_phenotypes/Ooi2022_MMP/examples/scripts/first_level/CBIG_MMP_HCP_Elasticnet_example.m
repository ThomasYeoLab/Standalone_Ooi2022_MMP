function CBIG_MMP_HCP_Elasticnet_example(outerFolds, innerFolds, feature_path, featurebase, split, outdir, ...
    subtxt, scorecsv, restrictedcsv, predvar, covtxt, ymat, covmat, y_idx)

% function HCP_Elasticnet(outerFolds, innerFolds, feature_path, featurebase, split, outdir, ...
%    subtxt, scorecsv, restrictedcsv, predvar, covtxt, ymat, covmat, y_idx)
% 
...
%
%   - featurebase
%     Base file name for the input features. Output folders generated in a folder `Elasticnet_(featurebase)`.
%
%   - split
