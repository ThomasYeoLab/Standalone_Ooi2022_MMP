...
# 
# EXAMPLE: 
#	CBIG_MMP_ABCD_Haufe.sh $input_dir $results_dir $feature 
# EXAMPLE OF HOW TO CALL FUNCTION:
# 	CBIG_MMP_ABCD_Haufe.sh data_dir/features output_dir 'features_rs' 	
...
matlab -nodesktop -nosplash -nodisplay -r " try addpath('$script_dir'); CBIG_MMP_ABCD_Haufe( \
