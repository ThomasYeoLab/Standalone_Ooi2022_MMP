function ABCD_Elasticnet(sites, innerFolds, feature_path, featurebase, outdir, ...
    subtxt, subcsv, predvar, covtxt, ymat, covmat, y_idx)

%function CBIG_MMP_ABCD_Elasticnet(sites, innerFolds, feature_path, featurebase, outdir, ...
%   subtxt, subcsv, predvar, covtxt, ymat, covmat, y_idx)
% 
% This function prepares the input parameters for the Elasticnet
...
%
%   - outdir
%     The full path of output directory where `Elasticnet_(featurebase)` will be created.
%
%   - subtxt
