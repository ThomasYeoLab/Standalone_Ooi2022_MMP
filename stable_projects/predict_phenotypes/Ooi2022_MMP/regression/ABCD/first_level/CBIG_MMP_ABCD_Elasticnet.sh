...
# 
# EXAMPLE: 
#	CBIG_MMP_ABCD_Elasticnet.sh $feature_path $outdir $sites $innerFolds $subtxt $subcsv \
#		$predvar $covtxt $ymat $covmat #y_idx
# EXAMPLE OF HOW TO CALL FUNCTION:
# 	CBIG_MMP_ABCD_Elasticnet.sh data_dir/features/rs.mat output_dir 3 10 data_dir/subs.txt \
...
matlab -nodesktop -nosplash -nodisplay -r " try addpath('$script_dir'); CBIG_MMP_ABCD_Elasticnet( \
