function CBIG_MMP_ABCD_multiKRR(sites, innerFolds, feature_dir, feature_mats_cell, ...
    kernel_groups, outstem_name, outdir, subtxt, subcsv, predvar, covtxt, ymat, ...
    covmat, fold_idx)
...
CBIG_MMP_MultiKRR_workflow_parallel_subfolds('',0, fullfile(outdir,fold_mat), ...
