function acc_vec = CBIG_HCP_read_model_results(outstem, outdir, N_seeds, N_folds, behav_ind, metric, store_new)

% acc_vec = CBIG_MMP_HCP_read_model_results(outstem, outdir, N_seeds, N_folds, behav_ind, metric, store_new)
% 
